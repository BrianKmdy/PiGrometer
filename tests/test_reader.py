...
def test_reader(mocker, _reader):
    ...
    mock_temperature = mocker.PropertyMock(side_effect=lambda: random.uniform(-1000, 1000))
    mock_humidity = mocker.PropertyMock(side_effect=lambda: random.uniform(-1000, 1000))
